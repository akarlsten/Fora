...
const CreateForumButton = () => (
  <div className="flex justify-end items-center">
    <Link href="/create">
      <button className={'transition duration-100 ease-in-out transform hover:-translate-y-1 hover:shadow-lg p-2 rounded border border-pink-200 bg-pink-200 hover:bg-pink-400 hover:border-pink-300 ml-4 flex flex-col items-center'}>
