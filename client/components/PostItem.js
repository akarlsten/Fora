        ...
        <div className="flex flex-row-reverse items-center sm:flex-col flex-shrink">
          ...
          {!userIsBanned && (
            owner.avatar ? (
              ...
              <svg className={'sm:my-2 w-12 md:w-32 lg:w-42 h-12 md:h-32 lg:h-42 rounded-full fill-current'} width="159" height="159" viewBox="0 0 159 159" fill="none" xmlns="http://www.w3.org/2000/svg">
