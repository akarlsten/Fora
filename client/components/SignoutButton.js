...
function SignoutButton () {
  ...
  return (
    <button className="flex items-center font-medium text-gray-800 transition duration-100 ease-in-out transform hover:text-pink-400" type="button" onClick={signout}>
